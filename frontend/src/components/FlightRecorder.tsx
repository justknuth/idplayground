...
import { FlightLog, simulateLoginFlow } from '../utils/mockAuthEngine';
...
export const FlightRecorder: React.FC<FlightRecorderProps> = ({ idpMode }) => {
  ...
  const handleSimulate = () => {
    ...
    setLogs(simulateLoginFlow(idpMode));
